...
var fightOrSkip = function () {
    ...
    if (promptFight === "skip") {
        ...
        if (confirmSkip) {
            window.alert(playerInfo.name + " has decided to run from this fight. Goodbye!");
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
        if (isPlayerTurn) {
            ...
            if (enemy.health <= 0) {
                ...
                console.log("Player money reward credited +20 points = " + playerInfo.money);
        ...
        // player gets attacked first
            ...
            // Log a resulting message to the console to check whether it worked.
            console.log(enemy.name + " attacked " + playerInfo.name + ". " + playerInfo.name + " now has " + playerInfo.health + " health points remaining.");
            ...
            if (playerInfo.health <= 0) {
                ...
                window.alert(playerInfo.name + " still has " + playerInfo.health + " health points left.");
            }
        }   // end of while loop
...
// PLAYER OBJECT WILL STORE PLAYERS DATA
var playerInfo = {
    name: getPlayerName(),
    health: 100,
    attack: 10,
    ...
    // this will refill players health
    ...
    // this will upgrade players attack power
...
// PLAYER OBJECT WILL STORE ENEMIES DATA
var enemyInfo = [
    {
        name: "Roborto",
